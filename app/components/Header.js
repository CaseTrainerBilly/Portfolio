  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
      <div className="mx-auto max-w-6xl px-4 pt-4 sm:px-6">
        <nav className="pointer-events-auto rounded-[28px] border border-gray-200/80 bg-white/90 px-5 py-4 shadow-lg backdrop-blur-md transition-all duration-300 dark:border-gray-800 dark:bg-gray-900/90 sm:px-6">
            ...
            {showNav && (
              <div
                className={`min-w-0 flex-1 overflow-hidden transition-all duration-300 ease-out ${
                  isNavOpen ? 'max-w-4xl opacity-100' : 'max-w-0 opacity-0'
                }`}
              >
